...
set "APP_NAME=Kidsnote_Memories_Saver_V1.01"
set "RELEASE_DIR=Kidsnote_Release_V1.01"
...
if /I "%BUILD_MODE%"=="onefile" (
    ...
    set "RELEASE_DIR=Kidsnote_Release_V1.01_onefile"
) else (
...
echo ===================================================
echo [Kidsnote Memories Saver V1.01] Release Build
echo ===================================================
echo.
