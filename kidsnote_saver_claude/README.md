# 🧒 Kidsnote Memories Saver (키즈노트 추억 저장기) V1.01
...
1. GitHub의 [Releases](../../releases) 페이지에서 최신 **`Kidsnote_Release_V1.01.zip`** 파일을 다운로드합니다.
2. 압축을 풀면 `Kidsnote_Memories_Saver_V1.01` 폴더가 나옵니다. 폴더 안의 **`Kidsnote_Memories_Saver_V1.01.exe`** 를 더블클릭하여 실행합니다. (폴더 안의 다른 파일들은 프로그램 구동용이니 지우지 마세요.)
...
- 🎯 **`Kidsnote_Release_V1.01.zip`** (빌드 스크립트가 자동으로 만들어준 100% 무설치 완성본입니다.)
